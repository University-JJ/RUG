...
%First we calculate the size of the activations
activationSize = size(activationsPooled);
rowsDim = activationSize(1)*activationSize(2)*activationSize(3);
columnsDim = activationSize(4);
activationsPooled = reshape(activationsPooled, rowsDim, columnsDim);
